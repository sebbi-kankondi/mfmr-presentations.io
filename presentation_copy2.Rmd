...
world_border <- read_sf(paste("C:/Users/Sebbitwo/Desktop/Academic/PhD/Write_Ups",
...
**4 Main sections** - names defined by research area/oceanic zone research is based in.
...
by employing monitoring and research programs i.e.,
...
Various monitoring and research programs i.e.,
...
using several culture techniques e.g.,
...
**4 Main sections** - names defined by research area/.blue[oceanic zone] research is based in.

Research objectives help determine marine resource management strategies for Namibian EEZ 
...
.pull-left[
- Pelagic & Demersal
   - Compilation of reports on population level parameters e.g., spp abundance, size composition, spatial distribution.  
]
...
.pull-right[
- Environment
   - Relating biological trends to oceanographic processes.
]
...
In conjunction with information obtained from the .blue[Directorate of Operations], Walvis Bay.

.panelset[
.panel[.panel-name[Landings]

.pull-left[
<img src="images/landings.png" width="280" height="220" />
.caption[
...
Research objectives set by the Marine Resources Act 27
...
All four heavily influenced by the Benguela current
...
.left-column[
- 1 of 4 .blue[Eastern Boundary Upwelling Systems]
]
.right-column[
